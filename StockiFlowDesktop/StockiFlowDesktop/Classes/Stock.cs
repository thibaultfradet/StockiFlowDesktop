...
namespace StockiFlowDesktop.Classes
{
    public class Stock
    {
        ...
        private bool isAugmenter;
        private string ISBN;

        public Stock() { }


        public Stock(int _id, int _quantite, string _raison, DateTime _DateStock,bool _isAugmenter, string _ISBN)
        {
            this.idStock = _id;
            this.Quantite = _quantite;
            this.RaisonStock = _raison;
            this.DateStock = _DateStock;
            this.isAugmenter = _isAugmenter;
            this.ISBN = _ISBN;
        }
        ...
        public bool getIsAugmenter() { return  isAugmenter; }
        ...
        public void setIsAugmenter(bool _isAugmenter) { this.isAugmenter= _isAugmenter; }
        public void setISBN(string _ISBN) { this.ISBN = _ISBN; }


        public void CreateStock()
        {
            string req_create = "insert into stock values(" + this.getIdStock() + "," + this.getQuantite() + ",'" + this.getRaisonStock() + "','" + this.getDateStock().ToString("yyyy-MM-dd") + "','" + this.getIsAugmenter() + "','" +this.getISBN() +  "');";
        ...
        {
            string req_retrieve = "select idStock,Quantite,RaisonStock,DateStock,isAugmenter,ISBN from stock where idStock = " + _id;
            ...
            using (MySqlDataReader reader = stmt_retrieve.ExecuteReader())
            {
                try
                {
                    ...
                    this.setIsAugmenter(bool.Parse(reader["isAugmenter"].ToString()));
        ...
        {
            string req_update = "update from stock set Quantite = " + this.getQuantite() + ",RaisonStock='" + this.getRaisonStock() + "',DateStock = '" + this.getDateStock().ToString("yyyy-MM-dd") + "'isAugmenter = '" + this.getIsAugmenter() + "',ISBN = '" + this.getISBN() + "'" + " where idStock = " + this.getIdStock();
        ...
        public List<Stock> FindAllStock()
        {
            ...
            string req_select = "select idStock,Quantite,RaisonStock,DateStock,isAugmenter,ISBN from stock";
            ...
            using (MySqlDataReader reader = stmt_select.ExecuteReader())
            {
                ...
                while (reader.Read())
                {
                    Stock stock_temp = new Stock(int.Parse(reader["idStock"].ToString()), int.Parse(reader["Quantite"].ToString()), reader["RaisonStock"].ToString(), DateTime.Parse(reader["DateStock"].ToString()), bool.Parse(reader["isAugmenter"].ToString()),reader["ISBN"].ToString());
